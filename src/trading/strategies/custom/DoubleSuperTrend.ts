			...
			variables: [
				{
					name: 'supertrendLT',
					source: 'taapi',
					input: { indicator: 'supertrend', params: { backtracks: 20, period: 20, multiplier: 5 } },
				},
				{
					name: 'supertrendST',
					source: 'taapi',
					input: { indicator: 'supertrend', params: { backtracks: 20, period: 8, multiplier: 3 } },
					// input: { indicator: 'supertrend', params: { backtracks: 20, period: 10, multiplier: 3 } },
				},
				{
					name: 'dmi',
					source: 'taapi',
					input: { indicator: 'dmi', params: { optInTimePeriod: 14, backtracks: 3 } },
				},
				{
					name: 'atr',
					source: 'taapi',
					input: { indicator: 'atr', params: { optInTimePeriod: 14, backtracks: 3 } },
				},
			],
		},
		{
